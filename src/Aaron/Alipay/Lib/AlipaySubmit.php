...
namespace Aaron\Alipay\Lib;

use Aaron\Alipay\Lib\AlipayCore;
use Aaron\Alipay\Lib\AlipayRsa;
...
class AlipaySubmit
{
     ...
     * @return 提交表单HTML文本
     */
    function buildRequestForm($para_temp, $method, $button_name,$test=false) {
        //待请求参数数组
        $para = $this->buildRequestPara($para_temp);
